...
PROTOBUF_NAMESPACE_OPEN
template <>
::api::v1::HelloRequest* Arena::CreateMaybeMessage<::api::v1::HelloRequest>(Arena*);
template <>
::api::v1::HelloResponse* Arena::CreateMaybeMessage<::api::v1::HelloResponse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class HelloRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:api.v1.HelloRequest) */ {
 public:
...
class HelloResponse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:api.v1.HelloResponse) */ {
 public:
